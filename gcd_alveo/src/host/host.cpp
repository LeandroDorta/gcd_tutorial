...
int main(int argc, char* argv[])
{
    ...
    int16_t h_a_data[MAX_LENGTH];                    // host memory for input vector
    int16_t h_b_data[MAX_LENGTH];
    int16_t h_data[MAX_LENGTH];
    char cl_platform_vendor[1001];
    const char* target_device_name =  argv[2];
      int16_t h_A_output[MAX_LENGTH];                   // host memory for output vector
    cl_mem d_A;                         // device memory used for a vector

    int16_t h_B_output[MAX_LENGTH];                   // host memory for output vector
